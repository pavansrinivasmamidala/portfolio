  ...
  return (
    <div>
        <div className="techstack-header">
            <span>Technologies I  worked with</span>
        </div>
      <div className="slideshow">
        <div className="images"  data-aos="fade-left" data-aos-duration="1200">
          ...
          <div className="logo-card">
            <img
              src="https://img.icons8.com/material/96/000000/arch-linux.png"
              alt="not loading"
            />
          </div>
          <div className="logo-card">
          ...
          <div className="logo-card">
            <img
              src="https://img.icons8.com/ios/100/000000/ubuntu.png"
              alt="not loading"
            />
          </div>
          <div className="logo-card">
            <img
              src="https://img.icons8.com/ios-filled/100/000000/arduino.png"
              alt="not loading"
            />
          </div>
          <div className="logo-card">
          ...
          <div className="logo-card">
            <img
              src="https://img.icons8.com/windows/100/000000/rocketchat.png"
              alt="not loading"
            />
          </div>
          <div className="logo-card">   
